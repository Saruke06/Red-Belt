...
//		vector<Token> tmp;
//		while(tokens.size() != 0) {
//			if (tokens.back().IsEndSentencePunctuation() == true) {
//				tmp.push_back(move(tokens.back()));
//				tokens.pop_back();
//			} else break;
//		}
//		while(tokens.size() != 0) {
...
//			} else break;
//		}
//		Sentences.push_back({make_move_iterator(rbegin(tmp)), make_move_iterator(rend(tmp))});
//	}
//
//	return {make_move_iterator(rbegin(Sentences)), make_move_iterator(rend(Sentences))};
//}
