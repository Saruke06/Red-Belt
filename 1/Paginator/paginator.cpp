...
public:
	Paginator(Iterator begin, Iterator end, size_t page_size) {
		while (begin != end) {
			size_t remaining_size = end - begin;
			pages.push_back(IteratorRange{begin, next(begin, min(page_size, remaining_size))});
			begin = next(begin, min(remaining_size, page_size));
		}
	}
